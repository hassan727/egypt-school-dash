            ...
            <div className="overflow-x-auto mb-6">
                <table className="min-w-full border-collapse border border-gray-300 text-sm">
                    <thead className="bg-blue-100">
                        <tr>
                            <th className="text-right p-3 font-bold text-blue-900 border border-blue-200">التاريخ</th>
                            <th className="text-right p-3 font-bold text-blue-900 border border-blue-200">الحالة</th>
                            <th className="text-right p-3 font-bold text-blue-900 border border-blue-200">وقت الحضور</th>
                            <th className="text-right p-3 font-bold text-blue-900 border border-blue-200">وقت المغادرة</th>
                            <th className="text-right p-3 font-bold text-blue-900 border border-blue-200">ملاحظات</th>
                            {isEditing && !isReadOnly && (
                                <th className="text-right p-3 font-bold text-blue-900 border border-blue-200">إجراءات</th>
                            )}
                        </tr>
                    </thead>
