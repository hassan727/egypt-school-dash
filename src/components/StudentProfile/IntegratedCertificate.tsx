                        ...
                        <table className="w-full border-collapse border border-gray-300 print-table">
                            <thead>
                                <tr className="bg-gray-100">
                                    <th className="border border-gray-300 px-4 py-2 text-right font-bold">المادة</th>
                                    <th className="border border-gray-300 px-4 py-2 text-right font-bold">درجة المادة</th>
                                    <th className="border border-gray-300 px-4 py-2 text-right font-bold">التقدير</th>
                                </tr>
                            </thead>
                            <tbody>
                                {certificateGrades.map((grade, index) => (
                                    <tr key={grade.id || index} className="hover:bg-gray-50">
                                        ...
                                        <td className={`border border-gray-300 px-4 py-2 font-bold text-center ${getGradeColor(grade.finalGrade)}`}>
                                            {grade.finalGrade}/100
                                        </td>
                                        <td className="border border-gray-300 px-4 py-2 text-center">{getGradeLevel(grade.finalGrade)}</td>
                                    </tr>
                                ))}
