                                ...
                                <div className="overflow-x-auto">
                                    <table className="min-w-full border-collapse border border-gray-300">
                                        <thead className="bg-blue-100">
                                            <tr>
                                                <th className="px-6 py-3 text-right text-sm font-bold text-blue-900 border border-blue-200 uppercase">الاسم</th>
                                                <th className="px-6 py-3 text-right text-sm font-bold text-blue-900 border border-blue-200 uppercase">الرقم</th>
                                                <th className="px-6 py-3 text-right text-sm font-bold text-blue-900 border border-blue-200 uppercase">المرحلة</th>
                                                <th className="px-6 py-3 text-right text-sm font-bold text-blue-900 border border-blue-200 uppercase">الفصل</th>
                                                <th className="px-6 py-3 text-right text-sm font-bold text-blue-900 border border-blue-200 uppercase">النوع</th>
                                                <th className="px-6 py-3 text-right text-sm font-bold text-blue-900 border border-blue-200 uppercase">الحالة</th>
                                            </tr>
                                        </thead>
                                        <tbody className="bg-white divide-y divide-gray-200">
                                            {paginatedResults.map((student) => (
                                                <tr key={student.id} className="hover:bg-blue-50 transition-colors">
                                                    ...
                                                    <td className="px-6 py-4 border border-gray-200">
                                                        <span className={`inline-flex px-3 py-1 rounded-full text-xs font-bold border ${student.fileStatus === 'مكتمل'
                                                            ? 'bg-green-100 text-green-800 border-green-200'
                                                            : student.fileStatus === 'ناقص'
